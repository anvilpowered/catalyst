...
class CommonEventRegistrationService<TString, TPlayer, TCommandSource> @Inject constructor(
  registry: Registry,
  private val eventService: EventService,
  private val chatListener: ChatListener<TString, TPlayer, TCommandSource>,
  private val joinListener: JoinListener<TString, TPlayer, TCommandSource>,
  private val leaveListener: LeaveListener<TString, TPlayer, TCommandSource>,
  private val discordChatListener: DiscordChatListener<TString, TPlayer>,
