...
public class CommonExceptionCommand<TString, TCommandSource, TPermissionSubject> {
    ...
    public void exceptionCommand(TCommandSource source, TPermissionSubject subject, String[] args) {
