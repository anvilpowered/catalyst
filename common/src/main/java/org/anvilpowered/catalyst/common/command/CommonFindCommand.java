...
public class CommonFindCommand<
    ...
    public void findCommand(TCommandSource source, TPermissionSubject subject, String[] args) {
        if (!permissionService.hasPermission(subject, registry.getOrDefault(CatalystKeys.FIND))) {
