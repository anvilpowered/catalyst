...
public class CommonBanCommand<
    ...
    public void banCommand(TCommandSource source, TPermissionSubject subject, String[] args) {
        ...
        userService.getPlayer(userName).ifPresent(p -> {
            if (permissionService.hasPermission((TPermissionSubject) p, registry.getOrDefault(CatalystKeys.BAN_EXEMPT))) {
