...
public class CommonSwearCommand<TString, TCommandSource, TPermissionSubject> {
    ...
    public void swearCommand(TCommandSource source, TPermissionSubject subject, String[] args) {
