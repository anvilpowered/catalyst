...
class OnlineUserFormat(
    ...
    class Resolver(
        ...
        suspend def resolve(format: Component, placeholders: Placeholders, user: MinecraftUser.Online): Component =
        ...
        suspend def resolve(format: OnlineUserFormat, user: MinecraftUser.Online): Component =
            resolve(format.format, format.placeholders, user)
    }

    companion object : MessageFormat.Builder[Placeholders, OnlineUserFormat] {
        override def build(block: Placeholders.() -] Component): OnlineUserFormat {
