...
public final class MSEssentialsKeys {
    ...
    public static final Key<Boolean> CHAT_FILTER = new Key<Boolean>("CHAT_FILTER_ENABLE", false){
    };
    ...
    public static final Key<Boolean> PROXY_CHAT = new Key<Boolean>("PROXY_CHAT", true){
    };
    ...
    public static final Key<Boolean> TAB = new Key<Boolean>("TAB", true){
    };
