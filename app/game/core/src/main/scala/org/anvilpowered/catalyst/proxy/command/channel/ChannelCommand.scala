...
def [P : Player?] RequiredArgumentBuilder[CommandSource, String].suggestChannelArgument(
...
suspend def CommandExecutionScope[CommandSource].extractChannelArgument(
    channelService: ChannelService,
