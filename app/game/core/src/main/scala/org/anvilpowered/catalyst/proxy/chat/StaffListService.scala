...
class StaffListService(
    ...
    def staffNames(): List[Component] = staffNames
    def adminNames(): List[Component] = adminNames
    def ownerNames(): List[Component] = ownerNames

    def getStaffNames(player: String, adminPermission: Boolean, staffPermission: Boolean, ownerPermission: Boolean) {
        if (ownerPermission) {
    ...
    def removeStaffNames(player: String) {
