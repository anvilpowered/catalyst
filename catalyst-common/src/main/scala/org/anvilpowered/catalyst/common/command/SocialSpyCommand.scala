...
class SocialSpyCommand[TPlayer : TCommandSource, TCommandSource] @Inject constructor(
    private val pluginMessages: PluginMessages,
    private val userService: UserService[TPlayer, TPlayer],
    private val privateMessageService: PrivateMessageService
) {

    def execute(context: CommandContext[TCommandSource], playerClass: Class[*]): Int {
