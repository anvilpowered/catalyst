...
import org.anvilpowered.catalyst.api.member.XodusMemberRepository
...
class CommonXodusMemberRepository
    : CommonMemberRepository<EntityId, PersistentEntityStore>(),
    BaseXodusRepository<Member<EntityId>>, XodusMemberRepository {

    @Inject
    private lateinit var logger: Logger

    override fun getOneOrGenerateForUser(userUUID: UUID, userName: String, ipAddress: String, flags: BooleanArray): CompletableFuture<Member<EntityId>?> {
    ...
    override fun getOneForUser(userName: String): CompletableFuture<Member<EntityId>?> {
    ...
    override fun getForIpAddress(ipAddress: String): CompletableFuture<List<Member<EntityId>>> {
